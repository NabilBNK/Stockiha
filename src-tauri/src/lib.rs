...
pub fn run() {
    ...
    let inner: fn(tauri::ipc::Invoke<tauri::Wry>) -> bool = tauri::generate_handler![
        ...
        // WS-I-1: reporting foundation.
        commands::reports::get_reports_capabilities,
        commands::reports::get_sales_summary,
        commands::reports::get_sales_timeseries,
        commands::reports::get_sales_by_product,
        commands::reports::get_sales_by_category,
        commands::reports::get_sales_by_cashier,
        commands::reports::get_sales_by_hour,
        commands::reports::get_margin_alerts,
        // WS-I-2: finance, money owed and accountant reports.
        commands::reports::get_profit_and_loss,
        commands::reports::get_cash_flow,
        commands::reports::get_monthly_summary,
        commands::reports::get_receivables_aging,
        commands::reports::get_customer_statement,
        commands::reports::get_supplier_balances,
        commands::reports::get_supplier_statement,
